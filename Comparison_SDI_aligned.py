...
cutoff_EP = np.load('./OUTPUT/EPvsCTRL/cutoff_EP_dsi.npy')
cutoff_EP_rotated = np.load('./OUTPUT/ALIGN/cutoff_rotated_EP_dsi.npy')
cutoff_EP_ortho_rotated = np.load('./OUTPUT/ALIGN/cutoff_ortho_rotated_EP_dsi.npy')
cutoff_EP_matched = np.load('./OUTPUT/ALIGN/cutoff_matched_EP_dsi.npy')
...
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_HC, cutoff_EP_rotated, alternative='two-sided')
print(f"HC - EP rotated \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_EP_ortho_rotated, cutoff_EP_rotated, alternative='two-sided')
print(f"EP ortho rotated - EP rotated \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_EP_ortho_rotated, cutoff_EP_matched, alternative='two-sided')
print(f"EP ortho rotated - EP matched \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_EP, cutoff_EP_matched, alternative='two-sided')
print(f"EP - EP matched \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_EP_matched, cutoff_EP_rotated, alternative='two-sided')
print(f"EP matched - EP rotated \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
stat, p_mwu = scipy.stats.mannwhitneyu(cutoff_EP, cutoff_EP_ortho_rotated, alternative='two-sided')
print(f"EP - EP ortho rotated \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
print('====')
...
SDI_EP_RT = np.load('./OUTPUT/EPvsCTRL/SDI_EP_dsi_RT.npy')
SDI_HC_LT = np.load('./OUTPUT/EPvsCTRL/SDI_HC_dsi_LT.npy')
SDI_EP_LT = np.load('./OUTPUT/EPvsCTRL/SDI_EP_dsi_LT.npy')
SDI_EP_RT_rotated = np.load('./OUTPUT/ALIGN/SDI_rotated_EP_dsi_RT.npy')
SDI_EP_RT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_ortho_rotated_EP_dsi_RT.npy')
SDI_EP_RT_matched = np.load('./OUTPUT/ALIGN/SDI_matched_EP_dsi_RT.npy')
SDI_EP_LT_rotated = np.load('./OUTPUT/ALIGN/SDI_rotated_EP_dsi_LT.npy')
SDI_EP_LT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_ortho_rotated_EP_dsi_LT.npy')
SDI_EP_LT_matched = np.load('./OUTPUT/ALIGN/SDI_matched_EP_dsi_LT.npy')


surr_thresh_HC_RT = np.load('./OUTPUT/EPvsCTRL/SDI_surr_thresh_HC_dsi_RT.npy', allow_pickle=True)
surr_thresh_EP_RT = np.load('./OUTPUT/EPvsCTRL/SDI_surr_thresh_EP_dsi_RT.npy', allow_pickle=True)
surr_thresh_HC_LT = np.load('./OUTPUT/EPvsCTRL/SDI_surr_thresh_HC_dsi_LT.npy', allow_pickle=True)
surr_thresh_EP_RT_rotated = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_rotated_EP_dsi_RT.npy', allow_pickle=True)
surr_thresh_EP_RT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_ortho_rotated_EP_dsi_RT.npy', allow_pickle=True)
surr_thresh_EP_RT_matched = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_matched_EP_dsi_RT.npy', allow_pickle=True)
surr_thresh_EP_LT = np.load('./OUTPUT/EPvsCTRL/SDI_surr_thresh_EP_dsi_LT.npy', allow_pickle=True)
surr_thresh_EP_LT_rotated = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_rotated_EP_dsi_LT.npy', allow_pickle=True)
surr_thresh_EP_LT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_ortho_rotated_EP_dsi_LT.npy', allow_pickle=True)
surr_thresh_EP_LT_matched = np.load('./OUTPUT/ALIGN/SDI_surr_thresh_matched_EP_dsi_LT.npy', allow_pickle=True)
SDI_sig_subjectwise_HC_RT = np.load('./OUTPUT/EPvsCTRL/SDI_sig_subjectwise_HC_dsi_RT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_RT = np.load('./OUTPUT/EPvsCTRL/SDI_sig_subjectwise_EP_dsi_RT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_RT_rotated = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_rotated_EP_dsi_RT.npy', allow_pickle=True)    
SDI_sig_subjectwise_EP_RT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_ortho_rotated_EP_dsi_RT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_RT_matched = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_matched_EP_dsi_RT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_LT = np.load('./OUTPUT/EPvsCTRL/SDI_sig_subjectwise_EP_dsi_LT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_LT_rotated = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_rotated_EP_dsi_LT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_LT_ortho_rotated = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_ortho_rotated_EP_dsi_LT.npy', allow_pickle=True)
SDI_sig_subjectwise_EP_LT_matched = np.load('./OUTPUT/ALIGN/SDI_sig_subjectwise_matched_EP_dsi_LT.npy', allow_pickle=True)
...
Qind_EP_RT = np.load('./OUTPUT/EPvsCTRL/Q_ind_EP_dsi_RT.npy')
Qind_EP_RT_rotated = np.load('./OUTPUT/ALIGN/Q_ind_rotated_EP_dsi_RT.npy')
Qind_EP_RT_ortho_rotated = np.load('./OUTPUT/ALIGN/Q_ind_ortho_rotated_EP_dsi_RT.npy')
Qind_EP_RT_matched = np.load('./OUTPUT/ALIGN/Q_ind_matched_EP_dsi_RT.npy')
Qind_EP_LT = np.load('./OUTPUT/EPvsCTRL/Q_ind_EP_dsi_LT.npy')
Qind_EP_LT_rotated = np.load('./OUTPUT/ALIGN/Q_ind_rotated_EP_dsi_LT.npy')
Qind_EP_LT_ortho_rotated = np.load('./OUTPUT/ALIGN/Q_ind_ortho_rotated_EP_dsi_LT.npy')
Qind_EP_LT_matched = np.load('./OUTPUT/ALIGN/Q_ind_matched_EP_dsi_LT.npy')
...
stat, p_mwu = scipy.stats.mannwhitneyu(pearson_corrs_RT, pearson_corrs_RT_matched, alternative='two-sided')
print(f"RTLE - Matched \n Mann-Whitney U test statistic = {stat:.3f}, p-value = {p_mwu:.3g}")
